...
# =======================
strmprivacy_api_version := 2.10.1
...
api-lint:
	docker run --rm -v "${pwd}:/workspace" europe-west4-docker.pkg.dev/stream-machine-development/docker/build/google-api-linter:1.29.2 ./scripts/api-linter.sh
